...
<html lang="en">
  ...
  <nav  class="navbar navbar-light bg-color" style="background-color:steelblue;">
    ...
    $no = 1;
    $id = $_GET['id'];
	$data = mysqli_query($config,"select * from event_table where id='$id'");
     ...
     <div class="card-body">
         ...
         <div class="form-row">
          <div class="form-group col-md-6">
           ...
           <p class="card-text"><img src="date.png" width="25px" height="25px" />  <?php echo $detail['tanggal']; ?></p>
           <p class="card-text"><img src="place.png" width="25px" height="25px" />  <?php echo $detail['tempat']; ?></p>
           <p class="card-text"><img src="time.png" width="25px" height="25px" />  <?php echo $detail['mulai']; ?>-<?php echo $detail['berakhir']; ?></p>
         ...
         <a href="hapus.php?id=<?php echo $detail['id']; ?>" name="hapus" id="hapus" class="btn btn-danger btn-sm" >Delete</a>
         </div>
     </div>
        ...
        <div class="card-header bg-primary"></div>
            ...
            <div class="form-group">
             <label for="checkin">Tanggal</label>
               <input id="tanggal" name="tanggal" type="date" class="form-control" value="<?php echo $detail['tanggal']; ?>" >
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
